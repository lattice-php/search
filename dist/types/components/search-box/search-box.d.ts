 ...
 */
export declare function SearchBox({ endpoint, perPage, placeholder, title, shortcut, collapsed, children, "data-test": testId, }: SearchBoxProps): import("react").JSX.Element;
